...
png(file = "./results/3_Network_heatmap_GBM.png", width=7, height=7, units="in", res=800);
...
# Plot the dendrogram
png(file = "./results/3_Eigengene_dendrogram_GBM.png",width=7, height=7, units="in", res=800);
par(cex = 1.0)
plotEigengeneNetworks(MEs , "Eigengene Dendrogram - GBM", marDendro = c(0,4,2,0), plotHeatmaps = FALSE)
dev.off()

# Plot the heatmap matrix
png(file = "./results/3_Eigengene_heatmap_GBM.png", width=7, height=7, units="in", res=800);
par(cex = 1.0)
plotEigengeneNetworks(MEs, "Eigengene Adjacency Heatmap - GBM",
                      marDendro = c(0,4,2,0), plotDendrograms = FALSE, xLabelsAngle = 90)
dev.off()

##################### OV #######################

png(file = "./results/3_Network_heatmap_OV.png", width=7, height=7, units="in", res=800);
# Taking the dissimilarity to a power, say 10, makes the plot more informative by effectively changing
# the color palette; setting the diagonal to NA also improves the clarity of the plot
...
# Plot the dendrogram
png(file = "./results/3_Eigengene_dendrogram_OV.png", width=7, height=7, units="in", res=800);
par(cex = 1.0)
plotEigengeneNetworks(MEs , "Eigengene Dendrogram - OV", marDendro = c(0,4,2,0), plotHeatmaps = FALSE)
dev.off()

# Plot the heatmap matrix
png(file = "./results/3_Eigengene_heatmap_OV.png", width=7, height=7, units="in", res=800);
par(cex = 1.0)
plotEigengeneNetworks(MEs, "Eigengene Adjacency Heatmap - OV",
                      marDendro = c(0,4,2,0), plotDendrograms = FALSE, xLabelsAngle = 90)
dev.off()
...
png(file = "./results/3_Network_heatmap_BRCA.png", width=7, height=7, units="in", res=800);
# Taking the dissimilarity to a power, say 10, makes the plot more informative by effectively changing
# the color palette; setting the diagonal to NA also improves the clarity of the plot
...
# Plot the dendrogram
png(file = "./results/3_Eigengene_dendrogram_BRCA.png", width=7, height=7, units="in", res=800);
par(cex = 1.0)
plotEigengeneNetworks(MEs , "Eigengene Dendrogram - BRCA", marDendro = c(0,4,2,0), plotHeatmaps = FALSE)
dev.off()

# Plot the heatmap matrix
png(file = "./results/3_Eigengene_heatmap_BRCA.png", width=7, height=7, units="in", res=800);
par(cex = 1.0)
plotEigengeneNetworks(MEs, "Eigengene Adjacency Heatmap - BRCA",
                      marDendro = c(0,4,2,0), plotDendrograms = FALSE, xLabelsAngle = 90)
dev.off()
